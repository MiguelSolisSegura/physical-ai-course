...
//| echo: false
{
  ...
  container.style.cssText = "position:relative;width:100%;max-width:700px;margin:0 auto;background:#121212;border:1px solid #4a5568;border-radius:4px;overflow:hidden;";
  ...
  hud.innerHTML = `θ = ${quatData.angleTheta}° · axis = [${quatData.nx.toFixed(2)}, ${quatData.ny.toFixed(2)}, ${quatData.nz.toFixed(2)}]`;
